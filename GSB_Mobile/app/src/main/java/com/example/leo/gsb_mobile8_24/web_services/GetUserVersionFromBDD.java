 ...
 * Tâche Asynchrone éxecutant le webservice getUserVersion
 */

public class GetUserVersionFromBDD extends AsyncTask<Void, Void, String> {

    private Context context;
    private String url;

    public GetUserVersionFromBDD(Context context, String url) {

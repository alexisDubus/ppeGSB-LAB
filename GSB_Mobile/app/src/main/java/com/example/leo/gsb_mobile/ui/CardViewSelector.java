...
public class CardViewSelector extends AppCompatActivity{
    ...
    private void dropAllVisiteToBDDMySQL(VisiteDAO visiteDAO) {
        ...
        for (int i = 0; i < visiteDAO.count(); i++) {
            ...
            // TODO Changer IP (5)
            String url = "http://172.16.8.24/GSB/GSB_Mobile/webservices/setVisite_WS.php?datevisite=" + dateVisite + "&rdv=" + rdvOrNot + "&idutilisateur=" + idUser + "&idmedecin=" + idMedecin + "&heurearrivee=" + heureArrive + "&heuredepart=" + heureFin + "&heuredebut=" + heureDebut + "";

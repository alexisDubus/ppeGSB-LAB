...
import com.example.leo.gsb_mobile8_24.web_services.GetUserFromBDD;
import com.example.leo.gsb_mobile8_24.web_services.GetUserVersionFromBDD;
                ...
                if (login.isEmpty() || mdp.isEmpty()) {
                    ...
                    try {
                        ...
                        if (user.equals("[]\n")) {
                            ...
                            // On récupère ensuite la localisation
                            Location laPosition = getLocalisation();

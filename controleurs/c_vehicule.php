...
$lesVehicules = $pdo->getVehiculeUtilisateur($idUtilisateur);
...
switch($action){
	case 'validerCreationVehicule':{
		$libelle = $_REQUEST['libelle'];
                ...
                $idCategore = $_REQUEST['idCategorie'];
                
                $pdo->insertVehiculeUtilisateur($idUtilisateur, $idCategore, $plaque, $libelle);
		break;
	}
}
/*
